...
class PurchaseOrderForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['delivery_date'].widget.attrs.update({'class': 'form-control'})
        self.fields['payment_due_date'].widget.attrs.update({'class': 'form-control'})
        self.fields['status'].widget.attrs.update({'class': 'form-select'})
        self.fields['tax_rate'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Tax rate %'})
        self.fields['discount_percent'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Discount %'})
        self.fields['notes'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Add any special instructions...'})
